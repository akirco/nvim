...
local function next_tab_cycle()
  ...
  local next_index = current_index % #tabs + 1
...
local function prev_tab_cycle()
  ...
  local prev_index = (current_index - 2) % #tabs + 1
...
-- Buffers
vim.keymap.set('n', '<Tab>', '<cmd>bnext<CR>', { desc = 'Go to next buffer', noremap = true, silent = true })

vim.keymap.set('n', '<S-Tab>', '<cmd>bprev<CR>', { desc = 'Go to previous buffer', noremap = true, silent = true })
...
-- file browser toggle
vim.keymap.set('n', '<leader>E', '<cmd>Telescope file_browser<CR>', { desc = 'Toggle file browser', noremap = true, silent = true })
...
-- File management
-- Ctrl+B: Toggle file browser (telescope-file-browser)
vim.keymap.set('n', '<C-b>', '<cmd>Telescope file_browser<CR>', { desc = 'Toggle file browser', noremap = true, silent = true })
...
vim.keymap.set('n', '<leader>e', '<cmd>Telescope file_browser<CR>', { desc = 'Open file browser', noremap = true, silent = true })
