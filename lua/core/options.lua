...
o.guicursor = 'n-v-c:block,i-ci-ve:ver25,r-cr:hor20,o:hor50,a:blinkwait700-blinkoff400-blinkon250'
...
local groups = {
    ...
    "NonText", "SpecialKey", "VertSplit", "SignColumn",
    "EndOfBuffer", "Tabline", "TablineFill", "TablineSel",
    "StatusLine", "StatusLineNC", "Pmenu", "PmenuSel",
}
